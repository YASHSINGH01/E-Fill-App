  ...
  camera(){
    ...
    Scanner1() {
      ...
      Alert.alert(
        ...
        [
          ...
          {
            text: 'Camera',
            onPress: () => this.camera1(),
          },
          
          {
            text: 'Gallery',
            onPress: () => this.gallery1(),
          },
    ...
    gallery1(){
      ImagePicker.openPicker({
          ...
          console.log('image',image.path)
          this.setState({image2:image.path});
          this.setState({ photo: image.data });
          console.log('image12',this.state.filePath)
        });
  }
  camera1(){
      ImagePicker.openCamera({
  ...
  details(data){
    ...
    onSignupPressed = () => {
     ...
     console.log('fliepath',this.state.filePath,);
      ...
      data.append('warranty_image',this.state.filePath);
      data.append('track_image',this.state.photo);
...
  });
    ...
    render() {
        ...
        // console.log(item);
        let { isLoading, errors = {}, image1,image2,service_name, service_no,photo, Service_Type,Service_details,Service_Detail,chessis,chessislist,filePath, refId,customer_doc_no,customer_contact, customer_doc_type, repeatPass, isSelected } = this.state;
