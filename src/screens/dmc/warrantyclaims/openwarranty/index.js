...
const amd=[];
class openwarranty extends Component {
    constructor(props){
        super(props);
    ...
    getChargingStations = () => {
        ...
        HttpRequest.warranty_open({distributor_code:props.info.phone})
            .then(res => {
  ...
  invoice(item){
      ...
      navigation.navigate('Warrantyques', { item });
  }
            ...
            <View style={styles.row}>
                ...
                <View style={[styles.content, { flex: 3 }]}>
                    ...
                    <View style={[styles.row, styles.descriptionContent, { marginTop: 0 }]}>
                        ...
                        <Text style={[styles.text, styles.description, styles.leftAlign]} numberOfLines={1}>{item.warranty_detail}</Text>
                    </View>
                    <View style={[styles.row, styles.descriptionContent ]}>
                     ...
                     <View style={[styles.row, styles.descriptionContent]}>
                        <Text style={[styles.text, styles.description, styles.label]}>Warranty Date</Text>
                        <Text style={[styles.text, styles.description, styles.leftAlign]}>{item.warranty_open_date}</Text>
                    </View>
                    <View style={[styles.row, { justifyContent: 'space-between', alignItems: 'center'}]}>
                    {item.w_message=="Claim is Pending" ?
                      <Text style={styles.text1s}>{item.w_message}</Text>
                      :
                      item.w_message=="Accepted & U/P"?
                      <Text style={styles.text3s}>{item.w_message}</Text>
                      :  <Text style={styles.text2s}>{item.w_message}</Text>
}
                  </View>
                    {/*<View style={[styles.row, styles.descriptionContent]}>
    ...
    return (
        <View style={styles.container}>
            <View  style={styles.header}>
              <Header navigation={navigation} type={strings.dmc.o_list}/>
            </View>
            {/* {orders != 0 ?
...
export default connect(mapStateToProps,mapDispatchToProps)(openwarranty);
