...
const amd=[];
class closeservices extends Component {
    constructor(props){
        super(props);
    ...
    getChargingStations = () => {
        ...
        HttpRequest.serive_close({distributor_code:props.info.phone})
            .then(res => {
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(closeservices);
