...
class detailsOrder extends Component {
    ...
    getChargingStations = () => {
       ...
       console.log(item.order_id,'region')
        HttpRequest.dealer_orderdetails({order_id:item.order_id})
            .then(res => {
           ...
           <View style={styles.itemHeader}>
                ...
                <View style={styles.row}>
                    ...
                    <View style={[styles.content, { flex: 3 }]}>
                        <View style={styles.row}>
                            <Text style={[styles.text, styles.title]} numberOfLines={1}>{item.stock_id}</Text>
                        </View>
                        <View style={[styles.row, styles.descriptionContent, { marginTop: 10 }]}>
                            ...
                            <Text style={[styles.text, styles.description, styles.leftAlign]} numberOfLines={1}>{item.stock_name}</Text>
                        </View>
