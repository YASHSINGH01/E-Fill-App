...
class paidservice extends Component {
  constructor(props) {
    super(props);
...
// console.log('scan');
  ...
  free_list ()
  {
    ...
    HttpRequest.charger_paid_serive_list()
    .then(res => {
      this.setState({ isLoading: false });
      //  console.log("Phone Number Check api response ---------- ", res);
      const result = res.data;
      console.log("Charger Paid Service list api response ---------- ", result);
      if (res.status == 200 && result.error==false) {
      // console.log("service list",result.data);
       this.setState({document_type:result.data})
      // console.log(this.state.Service_Type,'service');
...
data.append('service_status_type',1);
if(this.state.audio==""){
...
data.append('service_type',"Paid Service");
    ...
    return (
      <View style={styles.container}>
        ...
        <Animatable.View animation="fadeInUpBig" style={styles.footer}>
          ...
          <Text style={styles.checkboxLabel1}> Following Service provided in this Service </Text>
...
<View style={styles.formField}>
       ...
       null
        :
<Text numberOfLines={2} style={{color:'#fff',textAlign:'left',fontSize:12,margin:2}}>Charges - Service Charge Including Oil  ₹ 450 </Text>}
...
{this.props.buycharger!=""?
<Text numberOfLines={2} style={{color:'#fff',textAlign:'left',fontSize:12,margin:2}}>Above mentioned services will be provided to you.Please Confirm before sharing OTP with the Franchisee.</Text>
:
<Text numberOfLines={2} style={{color:'#fff',textAlign:'left',fontSize:12,margin:2}}>Above mentioned services will be provided to you.Please Confirm before sharing OTP with the dealer.</Text>
  }
</View>
...
const mapStateToProps = state => {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(paidservice);
