...
class Carscanner extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: false,
    ...
    checkCarId = (payLoad, e) => {
    let{data}=this.props;
       // let { token} = this.props;
        HttpRequest.checkCarId(payLoad, this.props.token)
            .then(res => {
                this.setState({ isScanning: false });
                const result = res.data;
                console.log('checkcar',result)
        ...
        return (
            <View style={styles.container}>
                <View style={styles.header}>
                    <Header navigation={navigation} type={strings.cars.scan} />
                </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(Carscanner);
