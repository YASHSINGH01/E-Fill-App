...
export default class Carsuccess extends Component {
    constructor(props){
        super(props);
    }
            ...
            <View style={styles.container}>
                <Animatable.View animation="fadeInUpBig" style={styles.footer}>
                    ...
                    <View style={styles.textContainer}>
                        <Text style={[styles.buttonText, {color: '#fff', fontSize: 16}]}>{strings.cars.message}</Text>
                       <Text style={[styles.buttonText, {color: '#fff', fontSize: 16}]}>{strings.cars.message1}</Text>
