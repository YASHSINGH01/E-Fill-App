...
const amd=[];
class franchiseeStock extends Component {
    constructor(props){
        super(props);
    ...
    getChargingStations = () => {
        ...
        HttpRequest.franchisee_stock({distributor_code:props.info.phone})
            .then(res => {
  ...
  invoice(item){
      ...
      navigation.navigate('Soldform', { item ,role:"franchisee"});
           ...
           <View style={styles.itemHeader}>
                ...
                <View style={styles.row}>
                    ...
                    <View style={[styles.content, { flex: 3 }]}>
                        <View style={styles.row}>
                            <Text style={[styles.text, styles.title]} numberOfLines={1}>{item.part_detail.chargePointSerialNumber}</Text>
                        </View>
                        <View style={[styles.row, styles.descriptionContent, { marginTop: 0 }]}>
                            ...
                            <Text style={[styles.text, styles.description, styles.leftAlign]} numberOfLines={3}>{item.part_detail.chargePointModel}</Text>
                        </View>
                        ...
                        <View style={[styles.row, styles.descriptionContent]}>
                          ...
                          <Text style={[styles.text,styles.description, styles.leftAlign]}>{item.part_detail.shipment_status}</Text>
                          </View>
                  ...
                  <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}} colors={['#A4FF8B', '#22BC9D']} style={styles.signInButtons}>
                    <Text style={styles.buttonTexts}>Sell Charger</Text>
                  </LinearGradient>
              </TouchableRipple>  
                    </View>
                </View>
...
export default connect(mapStateToProps,mapDispatchToProps)(franchiseeStock);
