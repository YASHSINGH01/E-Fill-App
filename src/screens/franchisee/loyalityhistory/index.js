...
class FranLoyality extends Component {
    constructor(props) {
        super(props);
    ...
    getBookingHistory = () => {
    console.log('bookinghist',this.props.info.phone)
    ...
    onSubmit = (item) => {
        let{info}=this.props.info;
              ...
              axios.post('https://mobility.efillelectric.com/api/v1/loyalty-redeem-fran', {loyalty_points:this.state.dealer_no, pics:pics, distributor_code:this.props.info.phone , }, {
...
export default connect(mapStateToProps)(FranLoyality);
