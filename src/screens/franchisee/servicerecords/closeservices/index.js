...
const amd=[];
class fcloseservices extends Component {
    constructor(props){
        super(props);
    ...
    getChargingStations = () => {
        ...
        HttpRequest.service_close({franchisee_code:props.info.phone})
            .then(res => {
                
                const result = res.data;
                console.log("charger close API Response ---------- ", result);
                if (res.status == 200 ) {
  ...
  invoice(item){
      let type=0;
      console.log('close_invoice',item);
            ...
            <View style={styles.row}>
                ...
                <View style={[styles.content, { flex: 3 }]}>
                    ...
                    <View style={[styles.row, styles.descriptionContent]}>
                        ...
                        <Text style={[styles.text, styles.description, styles.leftAlign]} numberOfLines={1}>{item.customer_contact}</Text>
                    </View>
                    ...
                    <View style={[styles.row, styles.descriptionContent]}>
                        <Text style={[styles.text, styles.description, styles.label]}>Close Date</Text>
                        <Text style={[styles.text, styles.description, styles.leftAlign]}>{item.service_close_date}</Text>
                    </View>
    ...
    return (
        <View style={styles.container}>
            <View  style={styles.header}>
              <Header navigation={navigation} type={strings.dmc.closed_service}/>
            </View>
            {/* {orders != 0 ?
...
const mapStateToProps = (state) => {
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(fcloseservices);
