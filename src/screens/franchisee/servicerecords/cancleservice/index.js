...
export default class fotpcancel extends Component {
    constructor(props){
        super(props);
    ...
    sendOTP = () => {
        ...
        HttpRequest.charger_serive_otp({ phone: phone })
        .then(res => {
...
//                });
    ...
    // API call
    submitOtp = () => {
        let {service_id,service_response}=this.props.route.params;;
        ...
        HttpRequest.charger_service_closeverify({ service_id:service_id,service_response:service_response })
        .then(res => {
...
this.props.navigation.navigate("FService");
//                showMessage({
//                    message: strings.enterOtp.response.success.title,
...
//                });
    ...
    signUp = () => {
        ...
        HttpRequest.charger_serive_otpverify({ phone: phone, otp: otpArray.join("") })
        .then(res => {
            this.setState({ submittingOtp: false });
            const result = res.data;
