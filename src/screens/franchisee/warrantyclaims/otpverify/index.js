...
export default class serviceotp extends Component {
    constructor(props){
        super(props);
...
//                });
    ...
    submitOtp = () => {
        ...
        HttpRequest.serive_register({ phone: phone,chessis_no:chessis_no,service_name:Service_Type, service_detail:Service_Detail,distributor_code:passkey })
        .then(res => {
