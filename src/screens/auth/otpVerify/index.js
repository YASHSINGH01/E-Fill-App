...
import { Text, View, ScrollView, TouchableOpacity, TextInput, Keyboard, ActivityIndicator, KeyboardAvoidingView } from 'react-native'
//Library
...
export default class otpVerification extends Component {
    constructor(props){
        super(props);
console.log('dsug',this.props.route)
        ...
        if(this.props.route.params.formData != undefined){
            this.state1={mail:this.props.route.params.formData.email};
            }
            else{
    ...
    sendOTP = () => {
        ...
        if(this.props.route.params.formData != undefined){
            var { mail} = this.state1;
            }
            else{
                var {mail}="";
            }
        HttpRequest.sendOtp({ phone: phone,email_id:mail })
        .then(res => {
...
//                });
    ...
    onResendOtpButtonPress = () => {
        ...
        // resend OTP Api call
        HttpRequest.resendOtp({ phone: phone ,email_id:mail})
        .then(res => {
    ...
    onSubmitButtonPress = () => {
        ...
        ['phone']
          .forEach((name) => {
            let value = this.state[name];
            // console.log('onSubmitButtonPress23ww3',value);
            if (!value) {
                errors[name] = strings.error.emptyError;
              } 
    ...
    submitOtp = () => {
        ...
        HttpRequest.verifyOtp({ phone: phone, otp: otpArray })
        .then(res => {
                    ...
                    this.props.navigation.dispatch(
                        CommonActions.reset({
                          ...
                          routes: [
                            ...
                            {
                              name: 'ResetPassword',
                              params: { screen: "ResetPassword", phone: phone},
                            },
                          ],
                        })
                    );
                    // this.props.navigation.navigate("ResetPassword", { screen: "ResetPassword", phone: phone});
                } else {
                    this.signUp(this.props.route.params.formData);
                    // this.props.navigation.navigate("SignIn", { screen: "SignIn", status: 1 });
                }
            } else {
            ...
            <View style={styles.container}>
                ...
                <Animatable.View animation="fadeInUpBig" style={styles.footer}>
                    ...
                    <View style={styles.formField}>
                        ...
                        <Text style={styles.text}>{strings.enterOtp.otpSentMessage+' '+protectedNumber}</Text>
                        ...
                        <TextInput
                                ...
                                // onFocus={this.onFocus}
                                 onChangeText={(text)=>this.setState({otpArray:text})}
