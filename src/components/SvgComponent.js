...
const SvgComponent = (props) => {
    return (
    <Svg width={props.width ?? "100pt"} height={props.height ?? "100pt"} viewBox="0 0 463.199 463.199" preserveAspectRatio="xMidYMid meet">
        <Defs>
            <LinearGradient id="progress" x1="0" y1="1" x2="0" y2="0">
                <Stop id="stop1" offset={props.counter < 0 ? 0 : (props.counter > 1) ? 1 : props.counter } stopColor="#9dbb52" stopOpacity="1"/>
                <Stop id="stop2" offset={props.counter < 0 ? 0 : (props.counter > 1) ? 1 : props.counter }  stopColor="#9FA5AA" stopOpacity="0" />
            </LinearGradient>
        </Defs>
            <Path  stroke="white" strokeWidth="5" fill="url(#progress)" d="M455.141,172.846 c-12.827-6.715-47.824,4.588-56.941,10.454c-2.985-5.311-6.372-11.128-10.044-17.084c-18.775-30.452-34.697-48.099-48.678-53.947
